...
#### Check Data Sheets #### 
#Ageneotettix_nebrascensis is a species for Sweepnet data, B3,NG, sample 17 - should be phoetaliotes nebrascensis
#Melanoplus_deorum is a species for Sweepnet data, B3, NG, sample 16 - - should be ageneotettix deorum
#Melanoplus_nebrascensis is a species for Sweepnet data, B3, NG sample 7 - should be phoetaliotes nebrascensis
#Phoetaliotes_gladstoni is a species for Sweepnet data, B3, NG, sample 53 - should be melanoplus sanguinipes
#Phoetaliotes_sanguinipes is a species for Sweepnet data, B3, NG, sample 8 - should be melanoplus sanguinipes
